...
def get_parser():
    ...
    parser.add_argument('--test_img_dirs', default=project_path + "/datasets/ccpd-2019/rec_images/test", help='the test images path')
    ...
    parser.add_argument('--pretrained_model', default= project_path + '/runs/lprnet-pretrain.pth', help='pretrained base model')
